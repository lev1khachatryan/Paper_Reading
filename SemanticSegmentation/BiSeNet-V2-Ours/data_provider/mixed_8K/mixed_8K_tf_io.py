...
from local_utils.augment_utils.mixed_8K import augmentation_tf_utils as aug
...
class _mixed_8K_TfWriter(object):
    """
    ...
    def write_tfrecords(self):
        ...
        train_tfrecords_file_name = 'mixed_8K_train.tfrecords'
        ...
        val_tfrecords_file_name = 'mixed_8K_val.tfrecords'
...
class _mixed_8K_TfReader(object):
    """
    ...
    def __len__(self):
        ...
        :return:
        """
        tfrecords_file_paths = ops.join(self._tfrecords_dir, 'mixed_8K_{:s}.tfrecords'.format(self._dataset_flags))
...
class mixed_8K_TfIO(object):
    ...
    def __init__(self):
        ...
        """
        self._writer = _mixed_8K_TfWriter()
        self._train_dataset_reader = _mixed_8K_TfReader(dataset_flag='train')
        self._val_dataset_reader = _mixed_8K_TfReader(dataset_flag='val')
